...
@section('content')
    <div class="cv-builder-page">
        <div class="container-fluid py-4 cv-builder">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-end">
                                    <a href="{{ route('kejuruan.dashboard') }}" class="btn btn-danger">
            ...
            <form action="{{ route('kejuruan.cv.print') }}" method="POST" id="cvForm" target="_blank">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone"
                                    value="{{ old('phone', $student->phone ?? '') }}" placeholder="+62 812-xxxx-xxxx"
                                    required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="education-item border rounded p-3 mb-3" data-index="0">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="education[0][year_start]"
                                        placeholder="2020">
                                </div>
                                <div class="col-md-3">
                ...
                <div class="card mb-4 shadow-sm">
                    <div class="card-header bg-warning d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="bi bi-briefcase-fill me-2 text-primary"></i>Pengalaman Kerja (Opsional)
                        </h5>
                        ...
                        <div class="experience-item border rounded p-3 mb-3" data-index="0">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="experience[0][year_start]"
                                        placeholder="2023">
                                </div>
                                <div class="col-md-3">
    ...
    @push('styles')
        <style>
            ...
            /* Override for the primary card header to be white */
            .cv-builder .card.bg-primary h2 {
