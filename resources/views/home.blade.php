...
@section('content')
    <!-- Hero Section -->
    <section class="position-relative min-vh-100 overflow-hidden" style="background: linear-gradient(135deg, #1e3a5f 0%, #1c3453 50%, #2e5a7a 100%);">
        <!-- Decorative elements -->
        <div class="position-absolute w-100 h-100 overflow-hidden">
            <div class="position-absolute rounded-circle" style="top: 5rem; left: 2.5rem; width: 18rem; height: 18rem; background: rgba(245, 158, 11, 0.1); filter: blur(60px);"></div>
            <div class="position-absolute rounded-circle" style="bottom: 5rem; right: 2.5rem; width: 24rem; height: 24rem; background: rgba(245, 158, 11, 0.05); filter: blur(60px);"></div>
        </div>
        ...
        <div class="container position-relative py-5" style="z-index: 10;">
            <div class="row align-items-center" style="min-height: 70vh;">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill mb-4" style="background: rgba(245, 158, 11, 0.2);">
                    ...
                    <h1 class="display-4 fw-bold text-white mb-4" style="line-height: 1.2;">
                        Selamat Datang di
                        <span class="d-block" style="background: linear-gradient(135deg, #f59e0b 0%, #f97316 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 mb-5">
                        <a href="{{ route('student.register') }}" class="btn btn-light btn-lg px-4 py-3 rounded-3 fw-semibold d-inline-flex align-items-center gap-2 shadow-lg">
                            <i class="bi bi-people"></i>
                            Daftar Sekarang
                            <i class="bi bi-arrow-right"></i>
                        </a>
                        <a href="{{ route('about') }}" class="btn btn-outline-light btn-lg px-4 py-3 rounded-3 fw-semibold d-inline-flex align-items-center gap-2">
                ...
                <div class="col-lg-6 position-relative">
                    <div class="position-relative rounded-4 overflow-hidden shadow-lg">
                        <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=600&h=400&fit=crop"
                            alt="Kegiatan Belajar di Sekolah" class="img-fluid w-100" style="aspect-ratio: 16/9; object-fit: cover;">
                        <div class="position-absolute top-0 start-0 w-100 h-100" style="background: linear-gradient(to top, rgba(30, 58, 95, 0.3), transparent);"></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @foreach($school->programs as $program)
                        <div class="col-lg-4 col-md-6">
                            <div class="card border-0 shadow-lg rounded-4 h-100 p-4 transition-card">
                                <div class="mb-4 d-flex align-items-center justify-content-center rounded-3" style="width: 64px; height: 64px; background: linear-gradient(135deg, #1e3a5f 0%, #2d4a6f 100%);">
    ...
    @if($school && $school->facilities)
        <section class="py-5 py-lg-6" style="background: #f8fafc;">
            <div class="container py-5">
                <div class="text-center mb-5">
                    <span class="badge rounded-pill px-3 py-2 mb-3" style="background: rgba(245, 158, 11, 0.2); color: #d97706;">
                        Sarana Prasarana
                    </span>
                ...
                <div class="row g-3">
                    @foreach($school->facilities as $facility)
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="card border-0 shadow-sm rounded-4 h-100 p-4 text-center facility-card" style="cursor: pointer; transition: all 0.3s ease;">
                                <div class="mx-auto mb-3 d-flex align-items-center justify-content-center rounded-3" style="width: 48px; height: 48px; background: rgba(30, 58, 95, 0.1);">
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        @if($announcement->type === 'info')
                                            <span class="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-1">Informasi</span>
                                        @elseif($announcement->type === 'event')
                                            <span class="badge bg-success bg-opacity-10 text-success rounded-pill px-3 py-1">Acara</span>
                                        @else
    ...
    <!-- CTA Section -->
    <section class="position-relative py-5 py-lg-6 overflow-hidden" style="background: linear-gradient(135deg, #1e3a5f 0%, #2d4a6f 100%);">
        <div class="position-absolute w-100 h-100">
            <div class="position-absolute rounded-circle" style="top: 2.5rem; right: 5rem; width: 16rem; height: 16rem; background: rgba(245, 158, 11, 0.1); filter: blur(60px);"></div>
            <div class="position-absolute rounded-circle" style="bottom: 2.5rem; left: 5rem; width: 20rem; height: 20rem; background: rgba(245, 158, 11, 0.05); filter: blur(60px);"></div>
        </div>
        ...
        <div class="container position-relative py-5" style="z-index: 10;">
            <div class="text-center mx-auto" style="max-width: 700px;">
                ...
                <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                    ...
                    <a href="{{ route('contact') }}" class="btn btn-outline-light btn-lg px-4 py-3 rounded-3 fw-semibold d-inline-flex align-items-center gap-2">
            ...
            <div class="row g-4 position-relative">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="position-relative">
                        <div class="mx-auto mb-4 d-flex align-items-center justify-content-center rounded-circle shadow-lg" style="width: 64px; height: 64px; background: linear-gradient(135deg, #f59e0b 0%, #f97316 100%);">
