...
<style>
    /* Page specific style: make the main content area white while preserving card styles */
    .page-grades {
        color: #ffffff !important;
        /* main text set to dark for readability */
        min-height: calc(100vh - 160px);
        /* allow body chrome (navbar/footer) */
        padding-top: 24px;
        padding-bottom: 24px;
    }

    /* Keep card styles untouched (cards remain dark with white text) */
    .page-grades .card {
        color: #fff !important;
    }

    /* Icons inside the page (outside cards) should be dark; keep card icons white */
    .page-grades .bi,
    .page-grades i[class^="bi-"],
    .page-grades i[class*=" bi-"] {
        color: #000 !important;
        fill: #000 !important;
    }
    ...
    .page-grades .card .bi,
    .page-grades .card i[class^="bi-"],
    .page-grades .card i[class*=" bi-"] {
        color: #fff !important;
        fill: #fff !important;
    }

    /* Muted text outside cards should be darker to match white background */
    .page-grades .text-muted {
        color: #6b7280 !important;
    }

    /* Links in the white page background should be dark primary */
    .page-grades a {
...
@section('content')
    <div class="container py-4 page-grades">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body" style="background:#ffffff !important; color:#000000 !important;">
                        @if($grades->count() > 0)
                                        ...
                                        <div class="col-md-2">
                                            <div class="text-center">
                                                <div class="h3 text-danger">
                                                    {{ $gradeStats->get('D', 0) + $gradeStats->get('E', 0) }}
                                                </div>
                        ...
                        @else
                            <div class="text-center py-5" style="color:#000 !important;">
                                <i class="fas fa-chart-line fa-3x mb-3" style="color:#000 !important;"></i>
                                <h5 style="color:#000 !important;">Belum ada data nilai</h5>
                                <p style="color:#000 !important;">Nilai akan muncul setelah guru melakukan penilaian</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body bg-white" style="color:#000000 !important;">
                        @if($skills->count() > 0)
                            <div class="row">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        ...
                                                        <small
                                                            class="text-muted">{{ ucfirst(str_replace('_', ' ', $skill->skill_category)) }}</small>
                                                    </div>
                                                    <span
                                                        class="badge
                                                ...
                                                @if($skill->certificate_file)
                                                    <a href="{{ Storage::url($skill->certificate_file) }}"
