                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                @elseif($application->status === 'rejected')
                                    ...
                                    <p class="text-danger mt-2">Maaf, aplikasi Anda belum dapat kami setujui.</p>
                                @elseif($application->status === 'waiting_payment')
                                    <span class="badge bg-info fs-6">
                                        <i class="fas fa-credit-card me-1"></i>Menunggu Pembayaran
                                    </span>
                                    <p class="text-info mt-2">Silakan lakukan pembayaran sesuai instruksi.</p>
                                @endif
                            </div>
