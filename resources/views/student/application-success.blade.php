...
@section('content')
    <!-- WRAPPER UNTUK BACKGROUND PUTIH -->
                        ...
                        <div class="card-body text-center py-5">
                            ...
                            @if(session('application_number'))
                                <div class="alert alert-info">
                                    <h5 class="mb-2 text-dark">Nomor Aplikasi Anda:</h5>
                            ...
                            <div class="mb-4">
                                <p class="lead">Terima kasih telah mendaftar di sekolah kami. Aplikasi Anda sedang dalam
                                    proses
                                    review.</p>
                                ...
                                <p class="mb-0"><strong>Perhatian:</strong> Akun untuk login (email & password yang Anda
                                    masukkan) akan aktif hanya setelah admin menyetujui aplikasi Anda. Sampai disetujui,
                                    Anda
                                    tidak dapat masuk menggunakan akun tersebut.</p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('home') }}" class="btn btn-danger btn-lg w-100">
