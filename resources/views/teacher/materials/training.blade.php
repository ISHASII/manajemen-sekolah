...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3>Materi Pelatihan: {{ $trainingClass->title }}</h3>
            <a href="{{ route('teacher.materials.create') }}?training_class_id={{ $trainingClass->id }}"
        ...
        <div class="card">
            <div class="card-body">
                        ...
                        @foreach($materials as $m)
                            <div class="list-group-item d-flex justify-content-between align-items-start">
                                ...
                                <div>
                                    ...
                                    @endif
                                    <a href="{{ route('teacher.materials.edit', $m->id) }}?training_class_id={{ $trainingClass->id }}"
                ...
                @else
                    <div class="text-center py-5">Belum ada materi untuk kelas pelatihan ini.</div>
                @endif
            </div>
        </div>
    </div>
