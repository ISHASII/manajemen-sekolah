...
@section('title', 'Rekap Absensi Bulanan Pelatihan')

@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3>Rekap Absensi Bulanan - {{ $trainingClass->title }}</h3>
            ...
            <div>
                ...
                <a href="{{ route('teacher.training-class.attendance', $trainingClass->id) }}" class="btn btn-primary">Lihat
                    Harian</a>
            </div>
        </div>
