...
@section('title', 'Rekap Absensi Pelatihan')

@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3>Rekap Absensi - {{ $trainingClass->title }}</h3>
                ...
                @if(isset($selectedSubject) && $selectedSubject)
                    <div class="small text-muted">Pelajaran:
                        {{ optional(collect($trainingSubjects)->firstWhere('id', $selectedSubject))->name ?? '-' }}</div>
                @endif
            </div>
            <div>
                <a href="{{ route('teacher.training-class.detail', $trainingClass->id) }}"
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-auto">
                            <select name="subject_id" class="form-select">
                                ...
                                @foreach($trainingSubjects as $sub)
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach($trainingClass->students as $idx => $student)
                            <tr>
                                <td>{{ $idx + 1 }}</td>
